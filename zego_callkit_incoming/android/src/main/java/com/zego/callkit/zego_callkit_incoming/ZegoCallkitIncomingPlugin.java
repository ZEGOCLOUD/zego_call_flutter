package com.zego.callkit.zego_callkit_incoming;
...
import com.zego.callkit.zego_callkit_incoming.notification.PluginNotification;

import java.util.List;

/**
 * ZegoCallkitIncomingPlugin
 */
public class ZegoCallkitIncomingPlugin extends BroadcastReceiver implements FlutterPlugin, MethodCallHandler, ActivityAware {
  ...
  public void onAttachedToEngine(@NonNull FlutterPluginBinding flutterPluginBinding) {
    ...
    methodChannel = new MethodChannel(flutterPluginBinding.getBinaryMessenger(), "zego_callkit_incoming");
  ...
  public void onMethodCall(@NonNull MethodCall call, @NonNull Result result) {
    ...
    if (call.method.equals(Defines.FLUTTER_API_FUNC_ACTIVE_AUDIO_BY_CALLKIT)) {
      result.success(null);
    } else if (call.method.equals(Defines.FLUTTER_API_FUNC_LAUNCH_CURRENT_APP)) {
      launchMyApp();
