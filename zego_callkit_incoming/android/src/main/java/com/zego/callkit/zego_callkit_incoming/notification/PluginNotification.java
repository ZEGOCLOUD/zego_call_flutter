...
import com.zego.callkit.zego_callkit_incoming.R;
import com.zego.callkit.zego_callkit_incoming.StringUtils;

import java.util.List;

public class PluginNotification {
    public static String TAG = "ZEGOCALL_Notification";
