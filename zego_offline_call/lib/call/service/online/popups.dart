...
// Project imports:
import 'package:zego_offline_call/call/components/calling_page.dart';
import 'package:zego_offline_call/call/components/online_invitation_notify.dart';
...
class ZegoOnlineCallPopUps {
  ...
  void showInvitationByNotification(
    ...
    if (Platform.isAndroid) {
      ZegoCallIncomingPlugin.instance.addLocalCallNotification(
