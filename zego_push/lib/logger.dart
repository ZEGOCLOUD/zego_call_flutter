...
/// @nodoc
class ZegoPushLogger {
  static bool isZegoPushLoggerInit = false;

  /// init log
  Future<void> initLog() async {
    if (isZegoPushLoggerInit) {
      return;
    }
    ...
    return FlutterLogs.initLogs(
            ...
            logsWriteDirectoryName: 'zego/push',
            logsExportDirectoryName: 'zego/push/Exported',
