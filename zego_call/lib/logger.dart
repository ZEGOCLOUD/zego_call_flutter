...
/// @nodoc
class ZegoCallLogger {
  static bool isZegoCallLoggerInit = false;

  /// init log
  Future<void> initLog() async {
    if (isZegoCallLoggerInit) {
      return;
    }
    ...
    return FlutterLogs.initLogs(
            ...
            logsWriteDirectoryName: 'zego/call',
            logsExportDirectoryName: 'zego/call/Exported',
